...
@Repository(value="creditCardYearlyIncomeDao")
public class CreditCardYearlyIncomeDao extends AbstractReportDao {

	public CreditCardYearlyIncomeDao() {
	...
	public SqlRowSet query(Object[] parameter) {
		...
		sql.append("AND    T5.DTA_YEARLYINCOME < 180000 ");
