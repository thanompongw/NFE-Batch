...
public class SMSIncompleteDocBO extends BatchBO {
	...
	private static final String FUNCTION_ID = "SB018";
	
	private static final String BATCH_FILE_NAME = "SMS_IncompleteDoc_";
	...
	@Resource(name = "smsIncompleteDocDao")
