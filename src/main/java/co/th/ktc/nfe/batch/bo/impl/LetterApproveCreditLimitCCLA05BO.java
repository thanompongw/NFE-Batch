 ...
 *
 */
@Service(value = "letterApproveCreditLimitCCLA05Service")
public class LetterApproveCreditLimitCCLA05BO implements BatchBO {
	
	private static Logger LOG = Logger.getLogger(LetterApproveCreditLimitCCLA05BO.class);
	
	private static final String FUNCTION_ID = "SB009";
	
	private static final String BATCH_FILE_NAME = "LA05_";
	 ...
	 *  
	 */
	public LetterApproveCreditLimitCCLA05BO() {
	}
		...
		try {
			...
			for (BusinessError error : ce.getErrorList().getErrorList()) {
				CommonLogger.log(NFEBatchConstants.REPORT_APP_ID, 
								 ...
								 LetterApproveCreditLimitCCLA05BO.class);
			}
		}
